...
"use strict";
var KTModalContainerAdd = (function () {
  var t, e, o, n, r, i;
  return {
    init: function () {
      (i = new bootstrap.Modal(document.querySelector("#kt_modal_add_cont"))),
        (r = document.querySelector("#kt_modal_add_cont_form")),
        (t = r.querySelector("#kt_modal_add_cont_submit")),
        (e = r.querySelector("#kt_modal_add_cont_cancel")),
        (o = r.querySelector("#kt_modal_add_cont_close")),
        ...
        $(r.querySelector('[name="location"]')).on("change", function () {
          n.revalidateField("location");
        }),
