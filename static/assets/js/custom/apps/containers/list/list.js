...
"use strict";
var KTContainerList = (function () {
  var t,
    e,
    o,
    n,
    c = () => {
      n.querySelectorAll('[data-kt-cont-table-filter="delete_row"]').forEach(
        (e) => {
    ...
    r = () => {
      const e = n.querySelectorAll('[type="checkbox"]'),
        o = document.querySelector(
          '[data-kt-cont-table-select="delete_selected"]'
        );
      e.forEach((t) => {
        ...
        o.addEventListener("click", function () {
          Swal.fire({
            text: "Are you sure you want to delete selected containers?",
            icon: "warning",
            showCancelButton: !0,
            buttonsStyling: !1,
            confirmButtonText: "Yes, delete!",
            ...
            o.value
              ? Swal.fire({
                  text: "You have deleted all selected containers!.",
                  icon: "success",
                  buttonsStyling: !1,
                  confirmButtonText: "Ok, got it!",
                  customClass: {
              ...
              : "cancel" === o.dismiss &&
                Swal.fire({
                  text: "Selected containers was not deleted.",
                  icon: "error",
                  buttonsStyling: !1,
                  confirmButtonText: "Ok, got it!",
                  customClass: {
  ...
  const l = () => {
    const t = document.querySelector('[data-kt-cont-table-toolbar="base"]'),
      e = document.querySelector('[data-kt-cont-table-toolbar="selected"]'),
      o = document.querySelector(
        '[data-kt-cont-table-select="selected_count"]'
      ),
  ...
  return {
    init: function () {
      (n = document.querySelector("#kt_cont_table")) &&
        ...
        r(),
        document
          .querySelector('[data-kt-cont-table-filter="search"]')
          .addEventListener("keyup", function (e) {
            t.search(e.target.value).draw();
          }),
        (e = $('[data-kt-cont-table-filter="search"]')),
        (o = document.querySelectorAll(
          '[data-kt-cont-table-filter="phone"] [name="phone"]'
        )),
        document
          .querySelector('[data-kt-cont-table-filter="filter"]')
        ...
        c(),
        document
          .querySelector('[data-kt-cont-table-filter="reset"]')
          .addEventListener("click", function () {
