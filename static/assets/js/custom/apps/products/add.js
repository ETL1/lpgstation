  ...
  return {
    init: function () {
      (i = new bootstrap.Modal(
        ...
        (r = document.querySelector("#kt_modal_add_product_form")),
        (t = r.querySelector("#kt_modal_add_product_submit")),
        (e = r.querySelector("#kt_modal_add_product_cancel")),
        (o = r.querySelector("#kt_modal_add_product_close")),
        ...
        $(r.querySelector('[name="stock"]')).on("change", function () {
          n.revalidateField("stock");
        }),
                ...
                console.log("validated!"),
                  "Valid" == e
                    ? (t.setAttribute("data-kt-indicator", "on"),
                      (t.disabled = !0),
                      setTimeout(function () {
                        var _name = document.getElementById("name-value").value;
                        var unit_price =
