...
var KTCylinderList = (function () {
  var t,
    ...
    c = () => {
      n.querySelectorAll(
        '[data-kt-cylinder-table-filter="delete_row"]'
      ).forEach((e) => {
    ...
    r = () => {
      ...
      e.forEach((t) => {
        ...
        o.addEventListener("click", function () {
          Swal.fire({
            text: "Are you sure you want to delete selected cylinder?",
            icon: "warning",
            showCancelButton: !0,
            buttonsStyling: !1,
            confirmButtonText: "Yes, delete!",
            ...
            o.value
              ? Swal.fire({
                  text: "You have deleted all selected cylinder!.",
                  icon: "success",
                  buttonsStyling: !1,
                  confirmButtonText: "Ok, got it!",
                  customClass: {
  ...
  const l = () => {
    const t = document.querySelector('[data-kt-cylinder-table-toolbar="base"]'),
      e = document.querySelector('[data-kt-cylinder-table-toolbar="selected"]'),
      o = document.querySelector(
  ...
  return {
    init: function () {
      (n = document.querySelector("#kt_cylinder_table")) &&
        ...
        r(),
        document
          .querySelector('[data-kt-cylinder-table-filter="search"]')
          .addEventListener("keyup", function (e) {
            t.search(e.target.value).draw();
          }),
        (e = $('[data-kt-cylinder-table-filter="month"]')),
        (o = document.querySelectorAll(
          '[data-kt-cylinder-table-filter="payment_type"] [name="payment_type"]'
        )),
        document
          .querySelector('[data-kt-cylinder-table-filter="filter"]')
        ...
        c(),
        document
          .querySelector('[data-kt-cylinder-table-filter="reset"]')
          .addEventListener("click", function () {
